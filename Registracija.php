...
if(isset($_POST['registruj']))
{
    ...
    if(count($greske) == 0)
    {
        ...
        else
        {
            ...
            $query = "INSERT INTO korisnici(email, password, imeprezime, adresa, brojtelefona, ulogaid) VALUES('$email', '$passhash', '$ime', '$adresa', '$brojtelefona', 2)";
            
            if(!mysqli_query($link, $query))
                die("Greska: " . mysqli_error($link));
            
            $email = $lozinka = $lozinkaprovera = $ime = $adresa = $brojtelefona = "";
            
            $potvrda = '<div class="alert alert-success" role="alert">Uspešno ste se registrovali!</div>';
						...
						<div class="basic-login">
								...
								<div class="form-group">
									...
									<input class="form-control" id="imeprezime" type="text" placeholder="" name="imeprezime" value="<?php echo $ime; ?>">
                                                                ...
                                                                <div class="form-group">
                                                                <label for="adresa"><i class="icon-lock"></i> <b>Adresa za isporuku</b></label>
								...
								<div class="form-group">
									<button type="submit" class="btn pull-right" name="registruj">Registruj se</button>
